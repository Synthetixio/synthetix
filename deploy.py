...
files = ["contracts/Havven.sol", "contracts/EtherNomin.sol",
         "contracts/Court.sol"]
...
attempt(mine_txs, [w3_instance, txs], "Initialising contracts... ", print_exception=True)
