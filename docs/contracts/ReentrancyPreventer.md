...
In Synthetix this is used by [`ExternStateToken`](ExternStateToken.md) through [`TokenFallbackCaller`](TokenFallbackCaller.md) (hence [SNX](Synthetix.md) and all [Synths](Synth.md)) to secure their [ERC223](https://github.com/ethereum/EIPs/issues/223) fallback functions from reentrancy.
