...
class HavvenInterface(ExternStateTokenInterface, SelfDestructibleInterface):
    def __init__(self, contract):
        ...
        self.lastHavvenAverageBalance = lambda acc: self.contract.functions.lastHavvenAverageBalance(acc).call()
        ...
        self.lastIssuedNominAverageBalance = lambda acc: self.contract.functions.lastIssuedNominAverageBalance(acc).call()
