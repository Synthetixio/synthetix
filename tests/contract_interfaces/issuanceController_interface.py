...
class IssuanceControllerInterface():
    def __init__(self, contract, name):
        ...
        self.deposits = lambda index: self.contract.functions.deposits(index).call()
        self.depositStartIndex = lambda: self.contract.functions.depositStartIndex().call()
        self.depositEndIndex = lambda: self.contract.functions.depositEndIndex().call()
        self.totalSellableDeposits = lambda: self.contract.functions.totalSellableDeposits().call()
