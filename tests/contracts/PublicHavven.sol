...
contract PublicHavven is Havven {
    ...
    constructor(address _proxy, TokenState initialState, address _owner, address _oracle, uint initalHavvenPrice)
        Havven(_proxy, initialState, _owner, _oracle, initalHavvenPrice)
        public
    {}
