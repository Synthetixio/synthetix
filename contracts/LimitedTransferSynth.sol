...
contract LimitedTransferSynth is Owned, IERC20, ExternStateToken, MixinResolver, ISynth {
    ...
    // Configuration for limited transfers on testnet.
    ...
    function transfer(address to, uint value) public optionalProxy onlyWhitelistedTransfers returns (bool) {
    ...
    function transferAndSettle(address to, uint value) public optionalProxy onlyWhitelistedTransfers returns (bool) {
    ...
    function transferFrom(
        ...
        address to,
        uint value
    ) public optionalProxy onlyWhitelistedTransfers returns (bool) {
    ...
    modifier onlyWhitelistedTransfers() {
        /* Only allow whitelisted address to transfer for testnet competition */
        /* SEC-approved */
        require(canTransfer[messageSender], "Only whitelisted address can transfer");
        _;
    }
