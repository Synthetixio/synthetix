...
// https://docs.synthetix.io/contracts/source/contracts/mixinsystemsettingsl1
contract MixinSystemSettingsL1 is MixinSystemSettings {
    ...
    // Note: the lack of a constructor for MixinSystemSettingsL1 means its use is dependent on a
    // subclassed contract to also be using MixinSystemSettings at some point in its dependency tree
