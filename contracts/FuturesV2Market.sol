 ...
 * =================
 *
 * FuturesV2 markets allow users leveraged exposure to an asset, long or short.
 ...
 *
 *     - ProxyFuturesV2.sol:         The Proxy is the main entry point and visible, permanent address of the market.
...
contract FuturesV2Market is IFuturesV2Market, FuturesV2MarketProxyable {
    /* ========== CONSTRUCTOR ========== */
