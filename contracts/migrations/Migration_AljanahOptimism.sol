...
contract Migration_AljanahOptimism is BaseMigration {
    ...
    function addressresolver_importAddresses_1() internal {
        bytes32[] memory addressresolver_importAddresses_names_1_0 = new bytes32[](2);
        addressresolver_importAddresses_names_1_0[0] = bytes32("RewardEscrowV2");
        addressresolver_importAddresses_names_1_0[1] = bytes32("Synthetix");
        address[] memory addressresolver_importAddresses_destinations_1_1 = new address[](2);
        addressresolver_importAddresses_destinations_1_1[0] = address(new_RewardEscrowV2_contract);
        addressresolver_importAddresses_destinations_1_1[1] = address(new_Synthetix_contract);
    ...
    function addressresolver_rebuildCaches_2() internal {
        ...
        addressresolver_rebuildCaches_destinations_2_0[0] = MixinResolver(new_Synthetix_contract);
        addressresolver_rebuildCaches_destinations_2_0[1] = MixinResolver(0xF4EebDD0704021eF2a6Bbe993fdf93030Cd784b4);
        addressresolver_rebuildCaches_destinations_2_0[2] = MixinResolver(0xf9FE3607e6d19D8dC690DD976061a91D4A0db30B);
        addressresolver_rebuildCaches_destinations_2_0[3] = MixinResolver(0xEb66Fc1BFdF3284Cb0CA1dE57149dcf3cEFa5453);
        addressresolver_rebuildCaches_destinations_2_0[4] = MixinResolver(0x136b1EC699c62b0606854056f02dC7Bb80482d63);
        addressresolver_rebuildCaches_destinations_2_0[5] = MixinResolver(0xA6bc30d854c2647574921c4AF442008DB7d32ad5);
        addressresolver_rebuildCaches_destinations_2_0[6] = MixinResolver(new_RewardEscrowV2_contract);
        addressresolver_rebuildCaches_destinations_2_0[7] = MixinResolver(0xB589Af3f2e3377A9a57da74bE1b6598926479505);
        addressresolver_rebuildCaches_destinations_2_0[8] = MixinResolver(0x24b4b6703a2eE7bA75a4Fc859B606F0bbaeef4EA);
        addressresolver_rebuildCaches_destinations_2_0[9] = MixinResolver(0x2DcAD1A019fba8301b77810Ae14007cc88ED004B);
