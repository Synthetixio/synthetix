...
const defaults = {
	...
	DYNAMIC_FEE_THRESHOLD: w3utils.toWei('0.004'), // 40 bps
	DYNAMIC_FEE_WEIGHT_DECAY: w3utils.toWei('0.9'), // dynamic fee weight decay for each round
	DYNAMIC_FEE_ROUNDS: '10', // dynamic fee rounds
